...
i1=findViewById(R.id.imageView6);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fStore.collection("users").whereEqualTo("Name", e1.getText().toString()).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    @Override
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        for (DocumentSnapshot snapshot: snapshotList)
                        {
                            ...
                            if(p1.getText().toString().contentEquals(""+snapshot.get("Password"))) {
                                Toast.makeText(MainActivity2.this, "OnSucess", Toast.LENGTH_SHORT).show();
                                f=2;
                                Intent i;
                        ...
                        if(f==1) Toast.makeText(MainActivity2.this, "Forget Your Password", Toast.LENGTH_SHORT).show();
                        if(f==0)
                        {
                            Toast.makeText(MainActivity2.this, "No Such user", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
        ...
        b1.setAnimation(sideanim);
        t6.setAnimation(botomanim);
